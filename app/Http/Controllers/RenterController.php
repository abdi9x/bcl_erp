...
class RenterController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::commit();
            return redirect()->route('renter.index')->with(['success' => 'Data ' . $request->nama . ' berhasil ditambahkan!']);
        } catch (\Throwable $th) {
            DB::rollBack();
            return redirect()->route('renter.index')->with(['error' => $th->getMessage()]);
        }
    }
    ...
    public function edit(renter $renter, Request $request)
    {
        try {
            ...
            return redirect()->route('renter.index')->with(['error' => 'Data gagal dihapus!']);
        }
    }
    ...
    public function update(Request $request, renter $renter)
    {
        try {
            ...
            DB::commit();
            return redirect()->route('renter.index')->with(['success' => 'Data ' . $request->nama . ' berhasil diubah!']);
        } catch (\Throwable $th) {
            DB::rollBack();
            return redirect()->route('renter.index')->with(['error' => $th->getMessage()]);
        }
    ...
    public function destroy(renter $renter, Request $request)
    {
        try {
            ...
            DB::commit();
            return redirect()->route('renter.index')->with(['success' => 'Data ' . $renter->nama . ' berhasil dihapus!']);
        } catch (\Throwable $th) {
            DB::rollBack();
            return redirect()->route('renter.index')->with(['error' => 'Data gagal dihapus!']);
        }
