                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ URL::asset('assets/images/renter/'.$renter->img)}}" class="image-popup-vertical-fit" title="{{$renter->nama}}">
                                                    <img class="thumb-sm rounded" style="max-height: 38px;width:100%" src="{{ URL::asset('assets/images/renter/'.$renter->img)}}">
                                                </a>
                                            </td>
...
<div class="modal fade bd-example-modal-xl" id="md_edit" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="POST" action="{{route('renter.update')}}" enctype="multipart/form-data">
