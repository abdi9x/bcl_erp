        ...
        return this.each(function () {
            ...
            var fileDivContent = `
                <label for="${fileUploadId}" class="file-upload">
                    ...
                    <input type="file" id="${fileUploadId}" name=receipt[] multiple hidden />
                </label>
            `;
                ...
                if (files.length > 0) {
                    $.each(files, function (index, file) {
                        ...
                        var preview = fileType.startsWith("image")
                            ...
                            : `<i class="mdi mdi-trash-can">visibility_off</i>`;
                        ...
                        tableBody.append(`
                            <tr>
                                ...
                                <td>${fileSize}</td>
                                <td>${fileType}</td>
                                <td><button type="button" class="deleteBtn"><i class="mdi mdi-trash-can"></i></button></td>
                            </tr>
                        `);
                    });
